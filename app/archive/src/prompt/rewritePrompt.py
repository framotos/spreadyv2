...
SYSTEM_PROMPT_REWRITE = Template("""You are a Data Scientist capable of analyzing a dataset. For context, today's date is ${today_date}. Your task it to rewrite code so that it answers the user's question and passes the evaluation.
