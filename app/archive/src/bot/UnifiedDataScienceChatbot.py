...
class UnifiedDataScienceChatbot(BaseChatbot):
    ...
    def generate_answer(
        ...
        **descriptions
        ...
        user_query = user_query + " Print Ziwschenergebnisse, so dass ich deine Schritte nachvollziehen und kontrollieren kann ohne den Code zu lesen!"
        ...
        self.temporary_messages = self.messages.copy()
        return raw_code
